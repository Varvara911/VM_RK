========================================================================
    ПРИЛОЖЕНИЕ : Обзор проекта spline_interpolation_v2
========================================================================

Это приложение spline_interpolation_v2 создано автоматически с помощью мастера 
приложений.  

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения spline_interpolation_v2.

spline_interpolation_v2.vcxproj
...
spline_interpolation_v2.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем spline_interpolation_v2.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
